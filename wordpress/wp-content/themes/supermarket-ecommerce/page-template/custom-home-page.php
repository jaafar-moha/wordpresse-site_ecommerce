						    ...
						    <div class="carousel-inner" role="listbox">
						        ...
						        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
						          	...
						          	<div class="carousel-caption">
							            ...
							            <div class="read-btn">
							              <a href="<?php esc_url(the_permalink()); ?>" class="" title="<?php esc_attr_e( 'READ MORE', 'supermarket-ecommerce' ); ?>"><?php esc_html_e('READ MORE','supermarket-ecommerce'); ?>
							              </a>
								       	</div>
						          	</div>
						        </div>
			            ...
			            while ( $query->have_posts() ) : $query->the_post(); ?>
			                <div class="slide-post">
			                    <strong><?php esc_html(the_title()); ?></strong>
			                  	...
			                  	<div class="more-btn">              
			                      <a href="<?php esc_url(the_permalink()); ?>"><?php esc_html_e('SHOP NOW','supermarket-ecommerce'); ?></a>
			                    </div>
		               		</div>
			            <?php endwhile; 
			            wp_reset_postdata();?>
