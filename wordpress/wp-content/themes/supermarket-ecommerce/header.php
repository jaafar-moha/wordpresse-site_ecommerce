				    	...
				    	<?php if(class_exists('woocommerce')){ ?>
				      	...
				      	<div class="col-lg-9 col-md-8">
							<div class="toggle-menu responsive-menu">
					            <button onclick="supermarket_ecommerce_open()" role="tab"><i class="fas fa-bars"></i><span class="screen-reader-text"><?php esc_html_e('Open Menu','supermarket-ecommerce'); ?></span></button>
					        </div>
